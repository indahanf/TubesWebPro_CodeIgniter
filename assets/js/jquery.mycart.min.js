  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" href="checkout.html" class="btn btn-primary" id="' + idCheckoutCart + '"">Checkout</button>' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    var drawTable = function(){
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '">Rp</strong></td>' +
        '<td></td>' +
        '</tr>'
      ...
      if(discountPrice !== null) {
        $cartTable.append(
          ...
          '<td></td>' +
          '<td></td>' +
          '<td><strong id="' + idDiscountPrice + '">Rp</strong></td>' +
          '<td></td>' +
          '</tr>'
        );
      }
    ...
    var showGrandTotal = function(products){
      ...
      $("#" + idGrandTotal).text("Rp. " + total);
    }
    var showDiscountPrice = function(products){
      $("#" + idDiscountPrice).text("Rp. " + options.getDiscountPrice(products));
    }
