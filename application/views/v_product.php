...
<head>
  ...
  crossorigin="anonymous"></script>
    	<link rel = "stylesheet" type = "text/css" 
         href = "<?php echo base_url(); ?>assets/css/v_product.css"> 
...
<div class="container-fluid" style="padding-top: 15px;">
	<div class="row">
		...
		<div class="col-md-<?php echo $bootstrapColWidth; ?>">
						...
						<button id="hoam" class='btn btn-danger btn-block my-cart-btn'>
									Add to cart
									</button>
						<button class='btn btn-danger btn-block cd-trigger'>
									Preview
									</button>
						</div>
		</div>	
